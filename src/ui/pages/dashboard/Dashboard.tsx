...
//   const [last365Daysprofit, setLast365Daysprofit] = useState(0);
...
//   const [last30DaysServicesCount, setLast30DaysServicesCount] = useState(0);
//   const [last365DaysServicesCount, setLast365DaysServicesCount] = useState(0);
//   const [dueAmount, setDueAmount] = useState(0);
//   const [last7DaysDueAmount, setLast7DaysdueAmount] = useState(0);
//   const [last30DaysDueAmount, setLast30DaysdueAmount] = useState(0);
//   const [last365DaysDueAmount, setLast365DaysdueAmount] = useState(0);
...
//   const [startDateOpen, setStartDateOpen] = useState(0);
//   const [endDateOpen, setEndDateOpen] = useState(0);
...
//       fetchLast30DaysProfit(),
//       fetchLast30DaysServicesCount(),
//       fetchLast30DaysDueAmount(),

//       fetchLast365DaysProfit(),
//       fetchLast365DaysServicesCount(),
//       fetchLast365DaysDueAmount(),
//     ]);
//   }, []);
...
//   const fetchLast30DaysProfit = async () => {
//     try {
//       //@ts-ignore
//       const { response } = await window.electron.last30DaysProfit();
//       setLast30Daysprofit(response.total_profit);
//     } catch (error) {
//       toast.error("Something went wrong. Please restart the application", {
//         position: "top-center",
//       });
...
//   const fetchLast365DaysProfit = async () => {
//     try {
//       //@ts-ignore
//       const { response } = await window.electron.last365DaysProfit();
//       setLast365Daysprofit(response.total_profit);
//     } catch (error) {
//       toast.error("Something went wrong. Please restart the application", {
//         position: "top-center",
//       });
...
//   const fetchLast30DaysServicesCount = async () => {
//     try {
//       //@ts-ignore
//       const { totalServicesCount } = await window.electron.last30DaysServicesCount();
//       setLast30DaysServicesCount(totalServicesCount.services_count);
//     } catch (error) {
//       toast.error("Something went wrong. Please restart the application", {
//         position: "top-center",
//       });
...
//   const fetchLast365DaysServicesCount = async () => {
//     try {
//       //@ts-ignore
//       const { totalServicesCount } = await window.electron.last365DaysServicesCount();
//       setLast365DaysServicesCount(totalServicesCount.services_count);
//     } catch (error) {
//       toast.error("Something went wrong. Please restart the application", {
//         position: "top-center",
//       });
...
//   const fetchLast30DaysDueAmount = async () => {
//     try {
//       //@ts-ignore
//       const { totalDueAmount } = await window.electron.getLast30DaysDueAmount();
//       setLast30DaysdueAmount(totalDueAmount);
//       // setDueAmount(totalServicesCount.services_count);
//     } catch (error) {
//       toast.error("Something went wrong. Please restart the application", {
//         position: "top-center",
...
//   const fetchLast365DaysDueAmount = async () => {
//     try {
//       //@ts-ignore
//       const { totalDueAmount } = await window.electron.getLast365DaysDueAmount();
//       setLast365DaysdueAmount(totalDueAmount);
//       // setDueAmount(totalServicesCount.services_count);
//     } catch (error) {
//       toast.error("Something went wrong. Please restart the application", {
//         position: "top-center",
...
//       const {response} =
//         //@ts-ignore
//         await window.electron.timelineSummary({ startDate, endDate });
//         console.log(response)
//       setCustomSummary({
//         profit: response.total_profit,
//         dueAmount: response.total_due_amount,
...
//           />
//         </div>
//         <p className="mt-4 mb-2 font-semibold">Last 30 days</p>
//         <div className="grid grid-cols-3 gap-4">
//           <CardV2
//             cardDescription="Last 30 days profit"
//             cardTitle={`AED ${last30Daysprofit ? last30Daysprofit : 0}`}
//           />
//           <CardV2
//             cardDescription="Last 30 days services"
//             cardTitle={`${last30DaysServicesCount}`}
//           />
//           <CardV2
//             cardDescription="Last 30 days due amount"
//             cardTitle={`AED ${last30DaysDueAmount ? last30DaysDueAmount : 0}`}
//           />
//         </div>

//         <p className="mt-4 mb-2 font-semibold">Last 365 days</p>
//         <div className="grid grid-cols-3 gap-4">
//           <CardV2
//             cardDescription="Last 30 days profit"
//             cardTitle={`AED ${last365Daysprofit ? last365Daysprofit : 0}`}
//           />
//           <CardV2
//             cardDescription="Last 365 days services"
//             cardTitle={`${last365DaysServicesCount}`}
//           />
//           <CardV2
//             cardDescription="Last 365 days due amount"
//             cardTitle={`AED ${last365DaysDueAmount ? last365DaysDueAmount : 0}`}
//           />
//         </div>
//         <div className="border mt-8 p-2 rounded-2xl bg-gray-200/60">
//           <div className="flex justify-between items-center">
//             <p className="mt-4 mb-2 font-semibold">Custom statistics</p>
...
//                 text="End date"
//               />
//               <Button variant={"outline"} onClick={handleCustomStats}>
//                 Submit
//               </Button>
//             </div>
//           </div>
//           <div className="grid grid-cols-3 gap-4">
//             <CardV2 cardDescription="Profit" cardTitle={`AED ${customSummary.profit}`} />
//             <CardV2 cardDescription="Services" cardTitle={`${customSummary.servicesCount}`} />
//             <CardV2
//               cardDescription="Due amount"
//               cardTitle={`AED ${customSummary.dueAmount}`}
//             />
//           </div>
//         </div>
//       </div>
